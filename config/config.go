...
func Load() Config {
	...
	cfg.PostgresDatabase = cast.ToString(getValueOrDefault("POSTGRES_DATABASE", "clinics"))
	cfg.PostgresPassword = cast.ToString(getValueOrDefault("POSTGRES_PASSWORD", "1001"))
	...
	cfg.DatabaseFolder = cast.ToString(getValueOrDefault("DB_FOLDER", "db/sql"))
